...
const NewCollections = () => {
  return (
    <div className=' flex flex-col items-center gap-[10px] mb-[120px] '>
      <h1 className='text-[#171717] text-[50px] font-semibold sm:text-[30px]'>NEW COLLECTIONS</h1>
        <hr className='border-gray-500 w-[200px]  bg-[#252525] rounded-[10px]'></hr>
        <div className='md:grid-cols-2 grid grid-cols-4 mt-[50px] gap-[30px] sm:grid-cols-2'>
