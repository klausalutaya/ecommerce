...
const Navbar = () => {
  ...
  return (
    <div className=" lg:py- lg:px-[40px] xl:py-[5px] xl:px-[50px] flex items-center justify-between mx-auto mt-5 mb-5 ">
      ...
      <div className="flex items-center gap-5 mr-[80px] xl:mr-[30px] lg:mr-0">
        <button className="hover:bg-gray-500 border rounded-[40px] w-[180px] h-[60px] text-[20px] font-open-sans mt-1 xl:w-[120px] xl:h-[45px] xl:text-[18px] lg:w-[110px] lg:h-[40px]">
          <Link to="/login">Login</Link>
        </button>
        <Link to="/cart">
          <img className="w-[40px] h-[40px] mt-3" src={cart_icon} alt="Cart" />
        </Link>
