  ...
  return (
    <div className='flex h-auto bg-[linear-gradient(180deg,_#fde1ff,_#e1ffea22_60%)] justify-center '>
      ...
      <div className='hero-left  flex-1 flex flex-col justify-center pl-[200px] md:pl-[50px]  leading-[1.5px] '>
        ...
        <p className='text-[80px] font-bold font-open-sans'>new
             </p> 
             <img className='w-[90px] sm:w-[50px] ' src={hand_icon} alt="" />
             </div>
        <p className='text-[80px] sm:text-[30px] font-open-sans leading-none font-bold'>collections</p>
        <p className='text-[80px] sm:text-[30px] font-open-sans leading-none font-bold'>for everyone</p>

      
        <button className='mt-[30px] flex justify-center items-center gap-[15px]   text-white text-[23px] font-open-sans w-[240px]  h-[70px] rounded-[75px] bg-red-500 font-medium' >Latest Collection     <img  src={arrow} alt="" />  </button>
