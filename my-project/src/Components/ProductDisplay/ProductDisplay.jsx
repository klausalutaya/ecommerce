...
const ProductDisplay = (props) => {
  ...
  return (
    <div className='flex mx-[150px] productdisplay'>
      <div className='flex gap-[16px] w-[60%]'>
    <div className='flex flex-col items-center justify-center  gap-[16px]'>
<img className='h-[163px] w-[300px]' src={product.image} alt="" />
<img className='h-[163px] w-[300px]  ' src={product.image} alt="" />
<img className='h-[163px]  w-[300px]' src={product.image} alt="" />
<img className='h-[163px]  w-[300px]' src={product.image} alt="" />
    ...
    <div className=' productdisplayimg'>
      <img  className='main-ing w-[1400px] h-[700px]' src={product.image} alt="" />

    </div>
      </div>
      
      <div className='right mx-[40px] flex flex-col w-[50%]'>
      <h1 className='text-[#3d3d3d] text-[24px] font-[700] '>{product.name}</h1>
        ...
        <div className='my-[10px] gap-[30px]'>
          ...
          <div className='right-description text-[10px] my-[40px]'>
        A lightweight, usually knitted, pullover shirt, close-fitting and with a round neckline and short sleeves, worn as undershirt or outer garment.
          ...
          <div className="flex gap-5 mt-3 cursor-pointer divproduct-displaysize">
            <div className='py-[18px] px-[24px] border-[1px] rounded-sm hover:bg-slate-400 hover:text-white'>S</div>
            <div className='py-[18px] px-[24px] border-[1px] rounded-sm hover:bg-slate-400 hover:text-white'>M</div>
            <div className='py-[18px] px-[24px] border-[1px] rounded-sm hover:bg-slate-400 hover:text-white'>L</div>
            <div className='py-[18px] px-[24px] border-[1px] rounded-sm hover:bg-slate-400 hover:text-white'>XL</div>
            <div className='py-[18px] px-[24px] border-[1px] rounded-sm hover:bg-slate-400 hover:text-white'>XXL</div>
          </div>
          </div>
