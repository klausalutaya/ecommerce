...
const Offers = () => {
  return (
    <div className=' offers w-[65%] h-auto flex m-auto py-0 px-[70px]  mb-[140px]  bg-[linear-gradient(180deg,_#fde1ff,_#e1ffea22_60%)] xl:mt-[140px] mt-[140px] items-center justify-center xl:py-[20px] xl:w-[70%] lg:w-[75%] sm:flex-col sm:items-center sm:py-[30px] sm:justify-center  '>
      <div className='flex flex-col justify-center flex-1 offers-left'>
        ...
        <p className='text-[#171717] text-[22px] xl:text-[20px] font-semibold lg:text-[18px] sm:text-[16px]'>ONLY ON BEST SELLERS PRODUCTS</p>
